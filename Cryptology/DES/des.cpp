...
//输出密文  
//  
void DES::OutPutCryptedMsg(char out[8])
{
	for (int i = 0; i < 8; i++)
	{
		out[i] = cryptedmsg[i];
...
//输出解密明文  
//  
void DES::OutPutDecipher(char out[8])
{
	for (int i = 0; i < 8; i++)
	{
		out[i] = decipher[i];
